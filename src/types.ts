...
export interface CloudAssetsPluginOptions {
  ...
  /** Заголовок модального окна выбора файла. */
  modalTitle?: string;
  /** Подпись блока в Block Manager. */
  blockLabel?: string;
  /**
   * Категория (группа) блока в Block Manager — отдельная секция, а не
   * общий список блоков вперемешку с блоками других плагинов.
   */
